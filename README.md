...
- [node-localstorage](https://github.com/lmaccherone/node-localstorage) - this can be used in a node environment to provide a compatible in-memory storage implementation.
